---
title: Device Hardening Baseline (Laptop + Phone)
date: '2026-01-27'
description: A quick baseline you can apply to new devices in under an hour.
tags:
- hardening
- opsec
- basics
...
## The core idea
Security work is easier when you turn it into a small number of *verifiable controls*. For **Device Hardening Baseline (Laptop + Phone)**, focus on:
